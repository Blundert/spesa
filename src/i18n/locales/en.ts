...
export const en: typeof it = {
  ...
  statistiche: {
    title: 'Statistics',
    emptyTitle: 'No shopping yet',
    emptyBody: 'Complete your first shopping session to see your data.',
    globalTitle: 'Overview',
    totalSpent: 'Total spent',
    sessions: 'Sessions',
    avgPerSession: 'Avg per session',
    favoriteSupermarket: 'Favourite supermarket',
    weeklyTitle: 'Trend (12 weeks)',
    topItemsTitle: 'Most purchased',
