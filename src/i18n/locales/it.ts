export const it = {
  ...
  settings: {
    ...
    syncConflictKeepLocal: 'Mantieni',
    syncConflictPull: 'Usa remoto',
  ...
  statistiche: {
    title: 'Statistiche',
    emptyTitle: 'Nessuna spesa ancora',
    emptyBody: 'Fai la tua prima spesa per vedere i tuoi dati.',
    globalTitle: 'Riepilogo',
    totalSpent: 'Totale speso',
    sessions: 'Sessioni',
    avgPerSession: 'Spesa media',
    favoriteSupermarket: 'Supermercato preferito',
    weeklyTitle: 'Andamento',
    topItemsTitle: 'Più acquistati',
    ...
    range: {
      ...
      '6m': '6 mesi',
      all: 'Tutto',
      customLabel: '{{n}} giorni',
      customTitle: 'Giorni personalizzati',
      customApply: 'Applica',
    },
  },
  catalogo: {
    ...
    deleteCategoryTitle: 'Eliminare "{{name}}"?',
    deleteCategoryBody: 'La categoria non ha articoli.',
    deleteCategoryHasItems: 'La categoria contiene ancora degli articoli.',
    deleteCategoryConfirm: 'Elimina categoria',
    renameItemTitle: 'Rinomina articolo',
    changeCategoryTitle: 'Cambia categoria',
    itemNamePlaceholder: 'Nome articolo',
    categoryLabel: 'Categoria',
    deleteItemTitle: 'Eliminare "{{name}}"?',
    deleteItemBody: 'Verrà rimosso anche dalla lista della spesa.',
    deleteItemHasPurchases: 'Articolo con acquisti storici — non eliminabile.',
    deleteItemConfirm: 'Elimina articolo',
    emptyItems: 'Nessun articolo nel catalogo.',
    added: '"{{name}}" aggiunta',
