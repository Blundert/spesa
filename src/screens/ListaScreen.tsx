...
export function ListaScreen() {
  ...
  const removeFromList = useRemoveFromList(isoWeek)
  ...
  const takenCount = listItems.filter((li) => purchasedItemIds.has(li.itemId)).length
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-[120px]">
        {/* Header — menu button is in AppLayout */}
